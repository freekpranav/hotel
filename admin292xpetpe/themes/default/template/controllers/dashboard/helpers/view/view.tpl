		...
		<div class="col-md-12 col-lg-2">
			...
			<section class="dash_links panel">
				<h3><i class="icon-link"></i> {l s="Useful links"}</h3>
					<dl>
						<dt><a href="" class="_blank">{l s="Official Documentation"}</a></dt>
						<dd>{l s="Vugha User Guide"}</dd>
					</dl>
					<dl>
						<dt><a href="" class="_blank">{l s="Vugha Forum"}</a></dt>
						<dd>{l s="Connect with the Vugha community"}</dd>
					</dl>
					<dl>
						<dt><a href="#" class="_blank">{l s="Vugha Addons"}</a></dt>
						<dd>{l s="Enhance your store Vugha modules"}</dd>
					</dl>
					<dl>
						<dt><a href="" class="_blank">{l s="Contact Us!"}</a></dt>
