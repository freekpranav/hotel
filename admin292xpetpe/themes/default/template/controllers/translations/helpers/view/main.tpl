	...
	<form method="get" action="index.php" id="typeTranslationForm" class="form-horizontal">
		<div class="panel">
			...
			<p class="alert alert-info">
				{l s='Here you can modify translations for every line of text inside Vugha.'}<br />
	...
	<form action="{$url_submit|escape:'html':'UTF-8'}" method="post" enctype="multipart/form-data" class="form-horizontal">
		<div class="panel">
			...
			<div id="submitAddLangContent" class="form-group">
				<p class="alert alert-info">
					{l s='You can add or update a language directly from the Vugha website here.'}<br/>
				...
				{else}
					<p class="text-danger">{l s='Cannot connect to the Vugha website to get the language list.'}</p>
				{/if}
			</div>
			<div class="panel-footer">
