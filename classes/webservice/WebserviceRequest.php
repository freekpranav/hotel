    ...
    */
    ...
    protected function authenticate()
    {
        if (!$this->hasErrors()) {
            ...
            if ($this->hasErrors()) {
                header('WWW-Authenticate: Basic realm="Welcome to Vugha Webservice, please enter the authentication key as the login. No password required."');
    ...
    protected function isActivated()
    {
        if (!Configuration::get('PS_WEBSERVICE')) {
            $this->setError(503, 'The Vugha webservice is disabled. Please activate it in the Vugha Back Office', 22);
            return false;
        }
        return true;
    }
