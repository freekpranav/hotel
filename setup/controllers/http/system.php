        ...
        $this->tests_render = array(
            ...
            'optional' => array(
                array(
                    ...
                    'checks' => array(
                        'new_phpversion' => sprintf($this->l('You are using PHP %s version. Soon, the latest PHP version supported by Vugha will be PHP 5.4. To make sure you’re ready for the future, we recommend you to upgrade to PHP 5.4 now!'), phpversion()),
