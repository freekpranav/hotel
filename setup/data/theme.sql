...
UPDATE `PREFIX_configuration` SET value = '#' WHERE name = 'BLOCKADVERT_LINK';
...
UPDATE `PREFIX_configuration` SET value = '#' WHERE name = 'BLOCKSOCIAL_FACEBOOK';
UPDATE `PREFIX_configuration` SET value = '#' WHERE name = 'BLOCKSOCIAL_TWITTER';
UPDATE `PREFIX_configuration` SET value = '#' WHERE name = 'BLOCKSOCIAL_GOOGLE_PLUS';
