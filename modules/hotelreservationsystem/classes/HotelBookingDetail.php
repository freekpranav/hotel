...
class HotelBookingDetail extends ObjectModel
{
    ...
    /**
     * [createQloAppsBookingByChannels create booking on Vugha commig from different channels]
    ...
    /**
     * [createQloCustomerAddressByChannelCustomerInfo create customer's Address in Vugha from supplied information from channel manager]
     * @param  [array] $params [array containg customer information]
