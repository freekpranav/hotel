<?php /* Smarty version Smarty-3.1.19, created on 2021-08-21 07:44:02
         compiled from "/opt/lampp/htdocs/hotelcommerce/themes/hotel-reservation-theme/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:124579473612092a2559221-29218194%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '81eceea9dbce16d6c97ca4b0da85047789aa0329' => 
    array (
      0 => '/opt/lampp/htdocs/hotelcommerce/themes/hotel-reservation-theme/modules/blockcart/blockcart.tpl',
      1 => 1617152312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '124579473612092a2559221-29218194',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_612092a272ec55_13713886',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_612092a272ec55_13713886')) {function content_612092a272ec55_13713886($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/opt/lampp/htdocs/hotelcommerce/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_modifier_replace')) include '/opt/lampp/htdocs/hotelcommerce/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_counter')) include '/opt/lampp/htdocs/hotelcommerce/tools/smarty/plugins/function.counter.php';
?>
<!-- MODULE Block cart -->
...
<?php $_tmp56=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&id_product=".$_tmp54."&ipa=".$_tmp55."&id_address_delivery=".$_tmp56."&token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp58=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['id_customization']->value);?>
<?php $_tmp59=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&id_product=".$_tmp57."&ipa=".$_tmp58."&id_customization=".$_tmp59."&token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)), ENT_QUOTES, 'UTF-8', true);?>
" rel="nofollow">&nbsp;</a>
													</div>
