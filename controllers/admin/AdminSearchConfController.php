    ...
    public function __construct()
    {
        ...
        $this->fields_options = array(
            'indexation' => array(
                ...
                'icon' => 'icon-cogs',
                'info' => '<p>
						'.$this->l('The "indexed" products have been analyzed by Vugha and will appear in the results of a front office search.').'<br />
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                array(
                    ...
                    'required' => true,
                    'hint' => array(
                        $this->l('Enter each alias separated by a comma (e.g. \'Vugha,preztashop,prestasohp\').'),
